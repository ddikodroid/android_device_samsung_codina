...
#    PRODUCT_COPY_FILES += vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/alsa.default.so:system/lib/hw/alsa.default.so
    PRODUCT_COPY_FILES += vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/copybit.GT-I8160.so:system/lib/hw/copybit.samsung.so
    PRODUCT_COPY_FILES += vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gps.GT-I8160.so:system/lib/hw/gps.codina.so
    PRODUCT_COPY_FILES += vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gralloc.default.so:system/lib/hw/gralloc.default.so
    PRODUCT_COPY_FILES += vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gralloc.GT-I8160.so:system/lib/hw/gralloc.samsung.so
...
#PRODUCT_COPY_FILES +=
    ...
    #PRODUCT_COPY_FILES += vendor/__MANUFACTURER__/__COMMON__/proprietary/keychars/codina-kp.kcm.bin:system/usr/keychars/codina-kp.kcm.bin
